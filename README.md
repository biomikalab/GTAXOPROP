...
Nashrulloh, H., Defi, S. A. Z., Rahardi, B., Tamam, M. B., Ruhimat, R., & Novita, H. (2025). *GTAXOPROP: A utility to generate input files for taxonomy propagation and assignment in QIIME/QIIME2 from the NCBI database* (Technical Report No. GBR-TR-BIOMIKA-01/Genbinesia/IX/2025). Generasi Biologi Indonesia Foundation. Gresik, Indonesia.

If you wish to cite this repository, you may use the following APA-style reference entry:

Nashrulloh, M. M., Defi, S. A. Z., Rahardi, B., Tamam, M. B., Ruhimat, R., & Novita, H. (2025). GTAXOPROP: A utility to generate input files for taxonomy propagation and assignment in QIIME/QIIME2 from the NCBI database (Version 1.0.0) [Computer software]. https://github.com/biomikalab/GTAXOPROP
